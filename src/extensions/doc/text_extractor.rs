...
mod tests {
    ...
    fn debug_print_paragraphs() {
        ...
        let word_doc = crate::extensions::doc::cfb_reader::read_word_document_stream(&path).unwrap();
        let fib = crate::extensions::doc::fib::parse_fib(&word_doc).unwrap();
        let table = crate::extensions::doc::cfb_reader::read_table_stream(&path, fib.f_which_tbl_stm).unwrap();
        let reconstructed = crate::extensions::doc::piece_table::parse_piece_table(
            &word_doc,
            &table,
            fib.fc_clx,
            fib.lcb_clx,
        ...
        .unwrap();
        let stylesheet = crate::extensions::doc::stylesheet::parse_stylesheet(
            &table,
            fib.fc_stshf,
            fib.lcb_stshf,
        )
        .unwrap();
        let props = crate::extensions::doc::paragraph_props::parse_paragraph_props(
            &word_doc,
            &table,
            fib.fc_plcf_papx,
            fib.lcb_plcf_papx,
